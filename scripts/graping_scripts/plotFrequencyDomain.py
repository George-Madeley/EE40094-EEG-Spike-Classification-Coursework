from preprocessing import loadPredictionData, createDataFrame, plotFrequencyDomain, lowPassFilter, highPassFilter, plotTimeDomain, normalizeAmplitudes

import matplotlib.pyplot as plt

high_pass_cutoff_freq = 50
low_pass_cutoff_freq = 200
